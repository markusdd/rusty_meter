            ...
            .show(ctx, |ui| {
                ui.label(
                    "Sequences of SCPI commands. A connect macro runs after the built-in \
                     settings bootstrap for the detected meter. Button macros appear on the main window.",
                );
                ui.separator();
                ...
                ui.horizontal(|ui| {
                    ...
                    if ui.add_enabled(can_dup, egui::Button::new("Duplicate")).clicked()
                    ...
                    if ui.add_enabled(can_dup, egui::Button::new("Delete")).clicked()
                        && let Some(id) = self.selected_macro_id.clone()
                    {
                ...
                ui.horizontal(|ui| {
                        ...
                        egui::ScrollArea::vertical()
                            ...
                            .show(ui, |ui| {
                                ...
                                for m in &self.scpi_macros {
                                    ...
                                    let selected = self.selected_macro_id.as_deref() == Some(m.id.as_str());
                    ...
                    ui.vertical(|ui| {
...

                        {
                            ...
                            ui.horizontal(|ui| {
                                ...
                                egui::ComboBox::from_id_salt("macro_target")
                                    ...
                                    .show_ui(ui, |ui| {
                                        ...
                                        if ui
                                            .selectable_label(
                                                matches!(m.applies_to, MacroTarget::OwonXdm6000),
                                                "Owon XDM 6000",
                                            )
                                            .clicked()
                                        {
                                        ...
                                        if ui
                                            .add_enabled(
                                                ...
                                                egui::Button::selectable(
                                                    matches!(m.applies_to, MacroTarget::Model(_)),
                                                    this_label,
                                                ),
                                            )
                                            .clicked()
                                        {
                                            m.applies_to = MacroTarget::Model(live_model.clone());
                                        }
                                        if ui
                                            .selectable_label(
                                                matches!(m.applies_to, MacroTarget::IdnContains(_)),
                                                "Custom IDN substring",
                                            )
                                            .clicked()
                                            && !matches!(m.applies_to, MacroTarget::IdnContains(_))
                                        {
                                            m.applies_to = MacroTarget::IdnContains(String::new());
                                        }
                                    });
                            });
                            ...
                            ui.checkbox(&mut m.show_as_button, "Show as button on main window");
